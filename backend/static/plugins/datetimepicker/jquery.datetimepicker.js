...
;(function (factory) {
	if ( typeof define === 'function' && define.amd ) {
		...
		define(['backend/static/plugins/datetimepicker/jquery', 'jquery-mousewheel'], factory);
	} else if (typeof exports === 'object') {
		// Node/CommonJS style for Browserify
		module.exports = factory(require('backend/static/plugins/datetimepicker/jquery'));;
	} else {
		// Browser globals
		factory(jQuery);
	}
